class PostsController < ApplicationController
  ...
  def parse_markdown
    ...
    parsed_markdown = ActionController::Base.helpers.sanitize(markdown(content.to_s), tags: %w(div span hr style mark dl dd dt img details summary a b iframe blockquote pre code br p table td tr thead tbody ul ol li h1 h2 h3 h4 h5 h6 em i strong), attributes: %w(style href id class src title width height frameborder allow allowfullscreen))
