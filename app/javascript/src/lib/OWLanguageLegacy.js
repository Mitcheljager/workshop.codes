...
const phraseIdentifier = /.+?(?=[\(\)\{\};,.=\n\[\]])/
const variable = /(?<=Global.)(\w+)/
...
function tokenBase(stream, state, prev) {
  ...
  if (stream.match(variable)) return "keyword"
