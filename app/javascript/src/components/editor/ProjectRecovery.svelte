...
<div class="project-recovery" transition:fly={{ y: 20, duration: 250 }}>
  ...
  <p>
    The <strong>fetched</strong> project was last saved <em>{ timeago.format($currentProject?.updated_at || "") }</em><br>
    The <strong>local</strong> project was last saved <em>{ timeago.format($recoveredProject?.updated_at || "") }</em>
  </p>
