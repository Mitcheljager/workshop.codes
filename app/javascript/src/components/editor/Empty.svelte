<div />
<div class="p-1/2 editor__scrollable">
  ...
  <div class="line-height-3/2">
    ...
    <p>
      Features:
      <ul>
        <li>Autocomplete any Workshop actions and values.</li>
        <li>Automatic variable detecting, no need to declare your variables anywhere.</li>
